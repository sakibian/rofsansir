...
export const useButtonHoverAnimation = (options: HoverAnimationOptions = {}): HoverAnimationResult => {
  const {
    scale = 1.05,
...
export const useCardHoverAnimation = (options: HoverAnimationOptions = {}): HoverAnimationResult => {
  const {
    scale = 1.02,
...
export const useLinkHoverAnimation = (options: HoverAnimationOptions = {}): HoverAnimationResult => {
  const {
    color = '#B6813E',
...
export const useImageHoverAnimation = (options: HoverAnimationOptions = {}): HoverAnimationResult => {
  const {
    scale = 1.05,
